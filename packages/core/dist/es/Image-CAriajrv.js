import { _ as e, w as a } from "./utils-xsKI4iFa.js";
...
const R = ["src"], Y = { class: "ym-image__toolbar" }, B = { class: "ym-image__arrow" }, M = e(l({ name: "YmImageViewer", __name: "ImageViewer", props: { urlList: {}, zIndex: { default: 3e3 }, initialIndex: { default: 0 }, hideOnClickModal: { type: Boolean, default: false }, zoomRate: { default: 0.2 }, minScale: { default: 0.1 }, maxScale: { default: 2 }, closeOnPressEsc: { type: Boolean, default: false } }, emits: ["close", "switch", "rotate", "wheel"], setup(e2, { expose: a2, emit: l2 }) {
  ...
  }, Y2 = s(() => l2.scrollContainer ? O(l2.scrollContainer) ? document.querySelector(l2.scrollContainer) : l2.scrollContainer : null), B2 = i(), D2 = i(null), V2 = () => {
    var _a;
    g2.value && ((_a = D2.value) == null ? void 0 : _a.observe(B2.value));
  ...
  return t(async () => {
    g2.value ? (await x(), await void (IntersectionObserver && (D2.value = new IntersectionObserver(R2, { root: Y2.value, rootMargin: "0px", threshold: 0.01 }))), V2()) : L2();
  }), r(() => {
    var _a;
    (_a = D2.value) == null ? void 0 : _a.unobserve(B2.value);
  }), z(() => l2.src, () => {
    g2.value ? V2() : L2();
  }), (e3, a3) => (c(), k("div", h({ class: "ym-image", ref_key: "imageRef", ref: B2 }, f(n2)), [m2.value ? (c(), k("div", P, [I(e3.$slots, "error", {}, () => [a3[0] || (a3[0] = C(" 加载错误 "))], true)])) : (c(), k(S, { key: 1 }, [!u2.value && v2.value ? (c(), k("img", { key: 0, class: "ym-image__inner", src: v2.value, alt: e3.alt, fit: e3.fit, loading: e3.loading, style: w({ "object-fit": e3.fit }), onLoad: b2, onError: E2, onClick: F }, null, 44, $)) : (c(), k("div", j, [I(e3.$slots, "loading", {}, () => [a3[1] || (a3[1] = _("div", { class: "ym-image__loading-text" }, " 加载中... ", -1))], true)]))], 64)), e3.preview ? (c(), k("div", X, [d(M, { ref_key: "previewRef", ref: q, "url-list": A.value, "initial-index": e3.initialIndex, "close-on-press-esc": e3.closeOnPressEscape, "hide-on-click-modal": e3.hideOnClickModal, "z-index": e3.zIndex, "zoom-rate": e3.zoomRate, "max-scale": e3.maxScale, "min-scale": e3.minScale, onSwitch: H, onClose: G }, null, 8, ["url-list", "initial-index", "close-on-press-esc", "hide-on-click-modal", "z-index", "zoom-rate", "max-scale", "min-scale"])])) : y("", true)], 16));
} }), [["__scopeId", "data-v-b0f9a688"]])), V = a(M);
export {
  V as Y,
  D as a
};
