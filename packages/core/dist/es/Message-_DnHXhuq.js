...
const oe = ["info", "success", "warning", "danger", "error"], te = { class: "ym-message__content" }, ne = { key: 0, class: "ym-message__close" }, se = A(e({ name: "YmMessage", __name: "Message", props: { id: {}, message: {}, duration: { default: 3e3 }, showClose: { type: Boolean, default: true }, center: { type: Boolean }, type: { default: "info" }, offset: { default: 10 }, zIndex: {}, transitionName: { default: "fade-up" }, onDestory: {} }, setup(e2, { expose: _2 }) {
  ...
  return n(() => {
    ...
    const { code: o2 } = e3;
    "Escape" === o2 && P2();
  }), _2({ close: P2, bottomOffset: I2 }), (e3, o2) => (a(), l(c, { name: e3.transitionName, onEnter: o2[0] || (o2[0] = (e4) => k2.value = C2.value.getBoundingClientRect().height), onAfterLeave: o2[1] || (o2[1] = (o3) => !B2.value && e3.onDestory()) }, { default: r(() => [i(u("div", { ref_key: "messageRef", ref: C2, class: d(["ym-message", { [`ym-message--${e3.type}`]: e3.type, "is-close": e3.showClose, "text-center": e3.center }]), style: m(M2.value), role: "alert", onMouseenter: L2, onMouseleave: A2 }, [p(D, { class: "ym-message__icon", icon: T2.value }, null, 8, ["icon"]), u("div", te, [f(e3.$slots, "default", {}, () => [e3.message ? (a(), l(y($), { key: 0, vNode: e3.message }, null, 8, ["vNode"])) : v("", true)], true)]), e3.showClose ? (a(), g("div", ne, [p(D, { icon: "xmark", onClick: b(P2, ["stop"]) })])) : v("", true)], 38), [[x, B2.value]])]), _: 3 }, 8, ["name"]));
} }), [["__scopeId", "data-v-41a36d94"]]), ae = _([]), { nextZIndex: le } = P(), ce = { type: "info", duration: 3e3, offset: 10, transitionName: "fade-up", showClose: true }, re = (e2) => {
...
const de = L(ue, "$YmMessage"), me = { class: "ym-message-box__title" }, pe = { class: "ym-message-box__content" }, fe = { key: 1, class: "ym-message-box__message" }, ye = { class: "ym-message-box__input" }, ve = { class: "ym-message-box__footer" }, ge = e({ name: "YmMessageBox", inheritAttrs: false, __name: "MesageBox", props: { visible: {}, doClose: {}, doAction: {}, destroy: {}, title: {}, message: {}, type: {}, boxType: { default: "" }, icon: {}, callback: {}, showClose: { type: Boolean, default: true }, showInput: { type: Boolean }, showCancelButton: { type: Boolean, default: true }, showConfirmButton: { type: Boolean, default: true }, cancelButtonText: { default: "取消" }, confirmButtonText: { default: "确定" }, cancelButtonLoading: { type: Boolean }, confirmButtonLoading: { type: Boolean }, cancelButtonDisabled: { type: Boolean }, confirmButtonDisabled: { type: Boolean }, cancelButtonType: { default: "default" }, confirmButtonType: { default: "primary" }, roundButton: { type: Boolean, default: false }, center: { type: Boolean }, lockScroll: { type: Boolean, default: true }, closeOnClickModal: { type: Boolean, default: true }, inputPlaceholder: { default: "请输入内容" }, inputValue: { default: "" }, inputType: { default: "text" }, buttonSize: {}, beforeClose: {} }, setup(e2) {
  const n2 = e2, { doAction: m2 } = n2, { nextZIndex: _2 } = P(), h2 = k({ ...n2, zIndex: _2() }), B2 = t(() => !!h2.message), C2 = t(() => h2.icon ?? j.get(h2.type ?? ""));
  s(() => {
    var _a;
  ...
  return (e3, o2) => (a(), l(c, { name: "fade-in-linear", onAfterLeave: e3.destroy }, { default: r(() => [i(p(W, { "z-index": h2.zIndex, mask: "" }, { default: r(() => [u("div", { role: "dialog", class: "ym-overlay-message-box", onClick: V2 }, [u("div", { ref: "rootRef", class: d(["ym-message-box", { "is-center": h2.center }]), onClick: o2[5] || (o2[5] = b(() => {
  }, ["stop"])) }, [y(U)(h2.title) ? v("", true) : (a(), g("div", { key: 0, ref_key: "headerRef", ref: z2, class: d(["ym-message-box__header", { "show-close": h2.showClose }]) }, [u("div", me, [C2.value && h2.center ? (a(), l(D, { key: 0, class: d({ [`er-icon-${h2.type}`]: h2.type }), icon: C2.value }, null, 8, ["class", "icon"])) : v("", true), I(" " + T(h2.title), 1)]), e3.showClose ? (a(), g("button", { key: 0, class: "ym-message-box__header-btn", onClick: b(R2, ["stop"]) }, [p(D, { icon: "xmark" })])) : v("", true)], 2)), u("div", pe, [C2.value && !h2.center && B2.value ? (a(), l(D, { key: 0, class: d({ [`ym-icon-${h2.type}`]: h2.type }), icon: C2.value }, null, 8, ["class", "icon"])) : v("", true), B2.value ? (a(), g("div", fe, [f(e3.$slots, "default", {}, () => [(a(), l(M(h2.showInput ? "label" : "p"), { for: h2.showInput ? y(A2) : void 0 }, { default: r(() => [I(T(h2.message), 1)]), _: 1 }, 8, ["for"]))], true)])) : v("", true)]), i(u("div", ye, [p(ee, { modelValue: h2.inputValue, "onUpdate:modelValue": o2[0] || (o2[0] = (e4) => h2.inputValue = e4), ref_key: "inputRef", ref: $2, placeholder: h2.inputPlaceholder, type: h2.inputType, onKeyup: O(E2, ["enter"]) }, null, 8, ["modelValue", "placeholder", "type"])], 512), [[x, h2.showInput]]), u("div", ve, [h2.showCancelButton ? (a(), l(X, { key: 0, class: "ym-message-box__footer-btn ym-message-box__cancel-btn", type: h2.cancelButtonType, round: h2.roundButton, loading: h2.cancelButtonLoading, onClick: o2[1] || (o2[1] = (e4) => L2("cancel")), onKeydown: o2[2] || (o2[2] = O(b((e4) => L2("cancel"), ["prevent"]), ["enter"])) }, { default: r(() => [I(T(h2.cancelButtonText), 1)]), _: 1 }, 8, ["type", "round", "loading"])) : v("", true), i(p(X, { class: "ym-message-box__footer-btn ym-message-box__confirm-btn", type: h2.confirmButtonType ?? "primary", round: h2.roundButton, loading: h2.confirmButtonLoading, onClick: o2[3] || (o2[3] = (e4) => L2("confirm")), onKeydown: o2[4] || (o2[4] = O(b((e4) => L2("confirm"), ["prevent"]), ["enter"])) }, { default: r(() => [I(T(h2.confirmButtonText), 1)]), _: 1 }, 8, ["type", "round", "loading"]), [[x, h2.showConfirmButton]])])], 2)])]), _: 3 }, 8, ["z-index"]), [[x, e3.visible.value]])]), _: 3 }, 8, ["onAfterLeave"]));
  ...
  return Z(e2) || h(e2) ? e2 = { message: e2 } : t2 = e2.callback, new Promise((n2, s2) => {
    const a2 = function(e3) {
      const t3 = document.createElement("div"), n3 = function(e4, t4) {
        const n4 = o(false), s4 = F(e4.message) || h(e4.message), a3 = p(be, { ...e4, visible: n4 }, s4 ? { default: (l2 = e4.message, F(l2) ? l2 : () => l2) } : void 0);
        var l2;
