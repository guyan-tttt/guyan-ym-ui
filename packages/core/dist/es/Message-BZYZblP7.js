import { defineComponent as e, ref as o, computed as t, onMounted as n, watch as s, openBlock as a, createBlock as l, Transition as c, withCtx as r, withDirectives as i, createElementVNode as u, normalizeClass as d, normalizeStyle as m, createVNode as f, renderSlot as p, unref as y, createCommentVNode as v, createElementBlock as g, withModifiers as b, vShow as x, shallowReactive as _, isVNode as h, h as B, render as k, reactive as C, nextTick as w, createTextVNode as I, toDisplayString as T, resolveDynamicComponent as M, withKeys as O } from "vue";
import { t as j, a as z, R as $, _ as A, b as L } from "./utils-CYRDgAxt.js";
import { d as V, e as Y, f as E, a as P } from "./hooks-dBYz_QDP.js";
import { Y as D } from "./Icon-BDui733g.js";
import { c as R, d as N, f as K, s as S, e as Z, g as H, h as U, i as q, j as F, k as G, l as J, p as Q } from "./vendor-CCTuhSiM.js";
import { Y as W } from "./Overlay-Bbem2dg7.js";
import { b as X } from "./Button-4f6NHTL2.js";
import { Y as ee } from "./Input-DzR2-Qs7.js";
const oe = ["info", "success", "warning", "danger", "error"], te = { class: "ym-message__content" }, ne = { key: 0, class: "ym-message__close" }, se = A(e({ name: "YmMessage", __name: "Message", props: { id: {}, message: {}, duration: { default: 3e3 }, showClose: { type: Boolean, default: true }, center: { type: Boolean }, type: { default: "info" }, offset: { default: 10 }, zIndex: {}, transitionName: { default: "fade-up" }, onDestory: {} }, setup(e2, { expose: _2 }) {
  const h2 = e2, B2 = o(false), k2 = o(), C2 = o(0), { topOffset: w2, bottomOffset: I2 } = V({ boxHeight: C2, offset: h2.offset, getLastBottomOffset: R(ie, h2) }), T2 = t(() => j.get(h2.type) ?? "circle-info"), M2 = t(() => ({ top: z(w2.value), zIndex: h2.zIndex }));
  let O2;
  function A2() {
    0 !== h2.duration && (O2 = N(E2, h2.duration));
  }
  function L2() {
    clearTimeout(O2);
  }
  ...
  return n(() => {
    ...
    e3 || (C2.value = -h2.offset);
  }), Y(document, "keydown", (e3) => {
    const { code: o2 } = e3;
    "Escape" === o2 && E2();
  }), _2({ close: E2, bottomOffset: I2 }), (e3, o2) => (a(), l(c, { name: e3.transitionName, onEnter: o2[0] || (o2[0] = (e4) => C2.value = k2.value.getBoundingClientRect().height), onAfterLeave: o2[1] || (o2[1] = (o3) => !B2.value && e3.onDestory()) }, { default: r(() => [i(u("div", { ref_key: "messageRef", ref: k2, class: d(["ym-message", { [`ym-message--${e3.type}`]: e3.type, "is-close": e3.showClose, "text-center": e3.center }]), style: m(M2.value), role: "alert", onMouseenter: L2, onMouseleave: A2 }, [f(D, { class: "ym-message__icon", icon: T2.value }, null, 8, ["icon"]), u("div", te, [p(e3.$slots, "default", {}, () => [e3.message ? (a(), l(y($), { key: 0, vNode: e3.message }, null, 8, ["vNode"])) : v("", true)], true)]), e3.showClose ? (a(), g("div", ne, [f(D, { icon: "xmark", onClick: b(E2, ["stop"]) })])) : v("", true)], 38), [[x, B2.value]])]), _: 3 }, 8, ["name"]));
} }), [["__scopeId", "data-v-41a36d94"]]), ae = _([]), { nextZIndex: le } = E(), ce = { type: "info", duration: 3e3, offset: 10, transitionName: "fade-up", showClose: true }, re = (e2) => {
...
const ue = (e2 = {}) => ((e3) => {
  const o2 = P().value, t2 = document.createElement("div"), n2 = { ...e3, id: o2, onDestory: () => {
    const e4 = H(ae, { id: o2 });
    -1 !== e4 && (ae.splice(e4, 1), k(null, t2));
  }, zIndex: le() }, s2 = B(se, n2);
  k(s2, t2), document.body.appendChild(t2.firstElementChild);
...
const de = L(ue, "$YmMessage"), me = { class: "ym-message-box__title" }, fe = { class: "ym-message-box__content" }, pe = { key: 1, class: "ym-message-box__message" }, ye = { class: "ym-message-box__input" }, ve = { class: "ym-message-box__footer" }, ge = e({ name: "YmMessageBox", inheritAttrs: false, __name: "MesageBox", props: { visible: {}, doClose: {}, doAction: {}, destroy: {}, title: {}, message: {}, type: {}, boxType: { default: "" }, icon: {}, callback: {}, showClose: { type: Boolean, default: true }, showInput: { type: Boolean }, showCancelButton: { type: Boolean, default: true }, showConfirmButton: { type: Boolean, default: true }, cancelButtonText: { default: "取消" }, confirmButtonText: { default: "确定" }, cancelButtonLoading: { type: Boolean }, confirmButtonLoading: { type: Boolean }, cancelButtonDisabled: { type: Boolean }, confirmButtonDisabled: { type: Boolean }, cancelButtonType: { default: "default" }, confirmButtonType: { default: "primary" }, roundButton: { type: Boolean, default: false }, center: { type: Boolean }, lockScroll: { type: Boolean, default: true }, closeOnClickModal: { type: Boolean, default: true }, inputPlaceholder: { default: "请输入内容" }, inputValue: { default: "" }, inputType: { default: "text" }, buttonSize: {}, beforeClose: {} }, setup(e2) {
  const n2 = e2, { doAction: m2 } = n2, { nextZIndex: _2 } = E(), h2 = C({ ...n2, zIndex: _2() }), B2 = t(() => !!h2.message), k2 = t(() => h2.icon ?? j.get(h2.type ?? ""));
  s(() => {
    var _a;
  ...
  return Z(e2) || h(e2) ? e2 = { message: e2 } : t2 = e2.callback, new Promise((n2, s2) => {
    const a2 = function(e3) {
      const t3 = document.createElement("div"), n3 = function(e4, t4) {
        ...
        var l2;
        return k(a3, t4), document.body.appendChild(t4.firstElementChild), a3.component;
      }({ ...e3, doClose: () => {
...
const he = { alert: { closeOnClickModal: false }, confirm: { closeOnClickModal: true }, prompt: { closeOnClickModal: true, showInput: true } };
