...
const T = Symbol("selectContext"), J = { modifiers: [{ name: "offset", options: { offset: [0, 9] } }, { name: "sameWidth", enabled: true, fn: ({ state: e2 }) => {
  ...
  const D2 = e2, F2 = n2, N2 = r(), Q2 = a(() => D2.disabled), ae2 = S().value, te2 = c(null), oe = c(), se = c(), ie = fe(D2.modelValue), ne = p({ highlightedIndex: -1, inputValue: (ie == null ? void 0 : ie.label) || "", loading: false, mouseHover: false, selectedOption: ie }), ue = c(false), { wrapperRef: de, isFocused: re, handlerBlur: ce, handlerFocus: pe } = O(oe, { beforeBlur: () => {
  }, afterBlur: () => {
  }, afterFocus: () => {
  } });
  function he() {
