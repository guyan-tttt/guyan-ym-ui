...
import { e as g } from "./hooks-Wd-CNMjI.js";
import { Y as k } from "./Icon-BPqbRGFK.js";
import { i as x, e as L, d as A, w as $ } from "./vendor-D1ZXl11B.js";
...
const V = Symbol("loading"), q = { mounted(e2, n2) {
  n2.value && B(e2, n2);
}, updated(e2, n2) {
  var _a;
...
function B(e2, n2) {
  ...
  e2[V] = { instance: w(l2), options: l2 };
}
const E = { name: "YmLoading", install(e2) {
  e2.config.globalProperties.$YmLoading = w, e2.directive("loading", q);
}, directive: q, service: w };
export {
  w as L,
  E as Y,
  q as v
