...
import { d as I, _ as $, w as V } from "./utils-BRb2rlgQ.js";
import { I as w } from "./Icon-BGmI14c6.js";
const x = Symbol("COLLAPSE_CTX_KEY"), E = { class: "ym-collapse" }, L = "YmCollapse", Y = $(e({ name: L, __name: "Collapse", props: { modelValue: {}, accordion: { type: Boolean } }, emits: ["update:modelValue", "change"], setup(e2, { emit: n2 }) {
  const m2 = e2, c2 = n2, r2 = a(m2.modelValue);
  function p2(e3) {
    r2.value = e3, c2("update:modelValue", e3), c2("change", e3);
  }
  return l(x, { activeNames: r2, handleItemClick: function(e3) {
    let a2 = [...r2.value];
    ...
    m2.accordion && r2.value.length > 1 && I(L, "accordion mode should only have one active item(手风琴模式应该只有一个激活的组件)");
  ...
  const a2 = e2, l2 = n(x, void 0), t2 = m(() => {
    var _a;
  ...
  return (e3, a3) => (o(), i("div", { class: c(["ym-collapse-item", { "is-disabled": e3.disabled }]) }, [r("div", { class: c(["ym-collapse-item__header", { "is-disabled": e3.disabled, "is-active": t2.value }]), id: `item-header-${e3.name}`, onClick: s2 }, [r("span", H, [d(e3.$slots, "title", {}, () => [p(u(e3.title), 1)], true)]), v(w, { icon: "angle-right", class: "header-angle" })], 10, A), v(h, _({ name: "slide" }, f(y(S))), { default: b(() => [g(r("div", K, [r("div", { class: "ym-collapse-item__content", id: `item-content-${e3.name}` }, [d(e3.$slots, "default", {}, void 0, true)], 8, P)], 512), [[C, t2.value]])]), _: 3 }, 16)], 2));
} }), [["__scopeId", "data-v-b89be678"]]), X = V(Y), q = V(T);
export {
  X as Y,
  q as a
};
