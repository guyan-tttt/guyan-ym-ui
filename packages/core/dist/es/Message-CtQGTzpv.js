...
import { t as O, a as $, R as j, _ as A, b as L } from "./utils-BHtccd4_.js";
...
const oe = ["info", "success", "warning", "danger", "error"], te = { class: "ym-message__content" }, ne = { key: 0, class: "ym-message__close" }, se = A(e({ name: "YmMessage", __name: "Message", props: { id: {}, message: {}, duration: { default: 3e3 }, showClose: { type: Boolean, default: true }, center: { type: Boolean }, type: { default: "info" }, offset: { default: 10 }, zIndex: {}, transitionName: { default: "fade-up" }, onDestory: {} }, setup(e2, { expose: _2 }) {
  const B2 = e2, h2 = o(false), C2 = o(), k2 = o(0), { topOffset: w2, bottomOffset: I2 } = V({ boxHeight: k2, offset: B2.offset, getLastBottomOffset: R(ie, B2) }), T2 = t(() => O.get(B2.type) ?? "circle-info"), M2 = t(() => ({ top: $(w2.value), zIndex: B2.zIndex }));
  let z2;
  function A2() {
  ...
  return n(() => {
    ...
    const { code: o2 } = e3;
    "Escape" === o2 && E2();
  }), _2({ close: E2, bottomOffset: I2 }), (e3, o2) => (a(), l(c, { name: e3.transitionName, onEnter: o2[0] || (o2[0] = (e4) => k2.value = C2.value.getBoundingClientRect().height), onAfterLeave: o2[1] || (o2[1] = (o3) => !h2.value && e3.onDestory()) }, { default: r(() => [i(u("div", { ref_key: "messageRef", ref: C2, class: d(["ym-message", { [`ym-message--${e3.type}`]: e3.type, "is-close": e3.showClose, "text-center": e3.center }]), style: m(M2.value), role: "alert", onMouseenter: L2, onMouseleave: A2 }, [f(D, { class: "ym-message__icon", icon: T2.value }, null, 8, ["icon"]), u("div", te, [p(e3.$slots, "default", {}, () => [e3.message ? (a(), l(y(j), { key: 0, vNode: e3.message }, null, 8, ["vNode"])) : v("", true)], true)]), e3.showClose ? (a(), g("div", ne, [f(D, { icon: "xmark", onClick: b(E2, ["stop"]) })])) : v("", true)], 38), [[x, h2.value]])]), _: 3 }, 8, ["name"]));
