import { defineComponent as e, inject as l, computed as a, openBlock as t, createElementBlock as o, normalizeClass as s, withModifiers as i, renderSlot as n, createVNode as u, unref as d, useSlots as r, ref as c, reactive as p, provide as h, watch as v, onMounted as f, withCtx as m, createElementVNode as b, createBlock as g, Fragment as y, renderList as V, mergeProps as _, nextTick as k, h as x } from "vue";
import { a as I } from "./Input-Df-qGDBJ.js";
import { a as M } from "./Tooltip-Bbn3XmFU.js";
import { a as w } from "./Icon-BN1S7njp.js";
import { a as S, d as O, u as B } from "./hooks-CF80WHXu.js";
import { R as L, _ as D, d as j, w as F } from "./utils-CPHIa2sh.js";
import { D as N, E as R, j as C, F as H, d as E, s as Y, g as z, G as A, r as W, z as $, f as U, A as q, c as G, H as K, e as P } from "./vendor-BXKGMoVT.js";
const T = Symbol("selectContext"), J = { modifiers: [{ name: "offset", options: { offset: [0, 9] } }, { name: "sameWidth", enabled: true, fn: ({ state: e2 }) => {
  ...
  const D2 = e2, F2 = n2, N2 = r(), Q2 = a(() => D2.disabled), ae2 = S().value, te2 = c(null), oe2 = c(), se = c(), ie = fe(D2.modelValue), ne = p({ highlightedIndex: -1, inputValue: (ie == null ? void 0 : ie.label) || "", loading: false, mouseHover: false, selectedOption: ie }), ue = c(false), { wrapperRef: de, isFocused: re, handlerBlur: ce, handlerFocus: pe } = O(oe2, { beforeBlur: () => {
  }, afterBlur: () => {
  }, afterFocus: () => {
  } });
  function he() {
