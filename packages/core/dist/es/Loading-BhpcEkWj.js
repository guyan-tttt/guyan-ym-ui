...
import { d as g } from "./hooks-CB8aTc5l.js";
import { Y as k } from "./Icon-ckGGeATQ.js";
import { d as x, i as L, q as A, r as $ } from "./vendor-Bde6p_Xx.js";
...
const V = Symbol("loading"), w = { mounted(e2, n2) {
  n2.value && B(e2, n2);
}, updated(e2, n2) {
  var _a;
  n2.value !== n2.oldValue && (!n2.value || n2.oldValue ? (_a = e2[V]) == null ? void 0 : _a.instance.close() : B(e2, n2));
}, unmounted(e2) {
  var _a;
...
function B(e2, n2) {
  ...
  e2[V] = { instance: q(l2), options: l2 };
}
const E = { name: "YmLoading", install(e2) {
  e2.config.globalProperties.$YmLoading = q, e2.directive("loading", w);
}, directive: w, service: q };
export {
  q as L,
  E as Y,
  w as v
