...
import { e as w, d as N, a as I } from "./hooks-CB8aTc5l.js";
import { t as O, R as j, _ as z, b as E } from "./utils-CN-UVqEO.js";
import { Y } from "./Icon-ckGGeATQ.js";
import { u as $, d as B, q as D, f as M, v as R, w as A, h as L } from "./vendor-Bde6p_Xx.js";
const W = ["info", "success", "warning", "danger"], q = ["top-right", "top-left", "bottom-right", "bottom-left"], H = { class: "ym-notification__text" }, T = { class: "ym-notification__title" }, Z = { class: "ym-notification__content" }, F = { key: 1, class: "ym-notification__close" }, G = z(t({ name: "YmNotification", __name: "Notification", props: { title: {}, id: {}, zIndex: {}, position: { default: "top-right" }, type: { default: "info" }, message: {}, duration: { default: 3e3 }, showClose: { type: Boolean, default: true }, offset: { default: 20 }, transitionName: { default: "fade" }, icon: {}, onClick: {}, onClose: {}, onDestory: {} }, setup(t2, { expose: x2 }) {
  const C2 = t2, k2 = o(false), b2 = o(), N2 = o(0), { topOffset: I2, bottomOffset: z2 } = w({ getLastBottomOffset: $(Q, C2), offset: C2.offset, boxHeight: N2 }), E2 = e(() => B(C2.icon) ? C2.icon : O.get(C2.type)), M2 = e(() => C2.position.endsWith("right") ? "right" : "left"), R2 = e(() => C2.position.startsWith("top") ? "top" : "bottom"), A2 = e(() => ({ [R2.value]: I2.value + "px", zIndex: C2.zIndex }));
  let L2;
  function W2() {
  ...
  return n(() => {
    k2.value = true, W2();
  }), x2({ close: G2, bottomOffset: z2 }), (t3, o2) => (s(), i(a, { name: `ym-notification-${t3.transitionName}`, onAfterLeave: o2[1] || (o2[1] = (o3) => !k2.value && t3.onDestory()), onEnter: o2[2] || (o2[2] = (t4) => N2.value = b2.value.getBoundingClientRect().height) }, { default: l(() => [c(f("div", { ref_key: "notifyRef", ref: b2, class: r(["ym-notification", { [`ym-notification--${t3.type}`]: t3.type, "show-close": t3.showClose, [M2.value]: true }]), style: d(A2.value), role: "alert", onClick: o2[0] || (o2[0] = (...o3) => t3.onClick && t3.onClick(...o3)), onMouseenter: q2, onMouseleave: W2 }, [E2.value ? (s(), i(Y, { key: 0, icon: E2.value, class: "ym-notification__icon" }, null, 8, ["icon"])) : u("", true), f("div", H, [f("div", T, m(t3.title), 1), f("div", Z, [p(t3.$slots, "default", {}, () => [t3.message ? (s(), i(v(j), { key: 0, vNode: t3.message }, null, 8, ["vNode"])) : u("", true)], true)])]), t3.showClose ? (s(), h("div", F, [y(Y, { icon: "xmark", onClick: g(G2, ["stop"]) })])) : u("", true)], 38), [[_, k2.value]])]), _: 3 }, 8, ["name"]));
