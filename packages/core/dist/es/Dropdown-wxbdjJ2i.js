...
import { Y as B } from "./Tooltip-QkeyQdsS.js";
import { a as C, b as g } from "./hooks-BLRbgP6P.js";
import { _ as z, w as $ } from "./utils-B0xUaq8Y.js";
import { Y as I, a as j } from "./Button-KDnyr0rH.js";
import { a as Y, i as D } from "./vendor-BmDHKAAA.js";
const O = Symbol("dropdownContext"), x = { key: 0, role: "separator", class: "divided-placeholder" }, T = ["id"], R = z(e({ name: "YmDropdownItem", __name: "DropdownItem", props: { command: { default: C().value }, label: {}, disabled: { type: Boolean, default: false }, divided: { type: Boolean, default: false } }, setup(e2) {
  ...
  return (e3, o2) => (d(), t(a, null, [e3.divided ? (d(), t("li", x)) : l("", true), s("li", { id: `dropdown-item-${e3.command ?? n(C)().value}`, class: m({ "ym-dropdown__item": true, ["ym-dropdown__item--" + v2.value]: v2.value, "is-disabled": e3.disabled, "is-divided": e3.divided }), onClick: y2 }, [r(e3.$slots, "default", {}, () => [p(u(e3.label), 1)], true)], 10, T)], 64));
} }), [["__scopeId", "data-v-0684de6a"]]), A = { class: "ym-dropdown__menu" }, S = $(z(e({ name: "YmDropdown", inheritAttrs: false, __name: "Dropdown", props: { type: {}, size: {}, items: {}, hideOnClick: { type: Boolean, default: true }, splitButton: { type: Boolean }, content: {}, trigger: { default: "click" }, placement: {}, manual: { type: Boolean }, disabled: { type: Boolean }, popperOptions: {}, transition: {}, showTimeout: {}, hideTimeout: {} }, emits: ["visible-change", "command", "click"], setup(e2, { expose: o2, emit: l2 }) {
  const p2 = e2, u2 = l2;
  c();
  ...
  return o2({ open: () => {
    ...
    var _a;
    return d(), t("div", { class: m(["ym-dropdown", { "is-disabled": p2.disabled }]) }, [y(B, _({ ref_key: "tooltipRef", ref: C2 }, $2.value, { "virtual-ref": (_a = x2.value) == null ? void 0 : _a.value, onVisibleChange: o3[1] || (o3[1] = (o4) => e3.$emit("visible-change", o4)) }), { content: b(() => [s("div", A, [r(e3.$slots, "dropdown", {}, () => [(d(true), t(a, null, k(e3.items, (e4) => (d(), h(R, _({ key: e4.command, ref_for: true }, e4), null, 16))), 128))], true)])]), default: b(() => [e3.splitButton ? (d(), h(n(I), { key: 0, type: e3.type, size: e3.size, disabled: e3.disabled }, { default: b(() => [y(n(j), { onClick: o3[0] || (o3[0] = w((o4) => e3.$emit("click", o4), ["stop"])) }, { default: b(() => [r(e3.$slots, "default", {}, void 0, true)]), _: 3 }), y(n(j), { ref_key: "triggerRef", ref: z2, icon: "angle-down" }, null, 512)]), _: 3 }, 8, ["type", "size", "disabled"])) : r(e3.$slots, "default", { key: 1 }, void 0, true)]), _: 3 }, 16, ["virtual-ref"])], 2);
  };
