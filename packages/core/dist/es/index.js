...
const R = /* @__PURE__ */ function(e2) {
  return (t2, a3) => {
    N(e2, (e3) => t2.use(e3)), a3 && g(a3, t2, true);
  };
}(E);
export {
  l as YmAlert,
