...
import { f as w, e as N, a as I } from "./hooks-CF80WHXu.js";
import { t as j, R as O, _ as z, b as E } from "./utils-CPHIa2sh.js";
import { Y } from "./Icon-BN1S7njp.js";
import { w as $, i as B, u as D, f as M, x as R, y as A, j as L } from "./vendor-BXKGMoVT.js";
const W = ["info", "success", "warning", "danger"], H = ["top-right", "top-left", "bottom-right", "bottom-left"], T = { class: "ym-notification__text" }, Z = { class: "ym-notification__title" }, q = { class: "ym-notification__content" }, F = { key: 1, class: "ym-notification__close" }, G = z(t({ name: "YmNotification", __name: "Notification", props: { title: {}, id: {}, zIndex: {}, position: { default: "top-right" }, type: { default: "info" }, message: {}, duration: { default: 3e3 }, showClose: { type: Boolean, default: true }, offset: { default: 20 }, transitionName: { default: "fade" }, icon: {}, onClick: {}, onClose: {}, onDestory: {} }, setup(t2, { expose: x2 }) {
  const C2 = t2, k2 = o(false), b2 = o(), N2 = o(0), { topOffset: I2, bottomOffset: z2 } = w({ getLastBottomOffset: $(Q, C2), offset: C2.offset, boxHeight: N2 }), E2 = e(() => B(C2.icon) ? C2.icon : j.get(C2.type)), M2 = e(() => C2.position.endsWith("right") ? "right" : "left"), R2 = e(() => C2.position.startsWith("top") ? "top" : "bottom"), A2 = e(() => ({ [R2.value]: I2.value + "px", zIndex: C2.zIndex }));
  let L2;
  function W2() {
