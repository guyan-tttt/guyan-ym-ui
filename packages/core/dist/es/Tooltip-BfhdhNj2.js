...
import { u as k } from "./hooks-dBYz_QDP.js";
import { q as T, f as b, r as w, c as x, i as j } from "./vendor-CCTuhSiM.js";
import { _ as B, w as L } from "./utils-CYRDgAxt.js";
const N = B(o({ name: "YmTooltip", __name: "Tooltip", props: { virtualRef: {}, virtualTriggering: { type: Boolean }, content: {}, trigger: { default: "hover" }, placement: { default: "bottom" }, manual: { type: Boolean }, disabled: { type: Boolean }, popperOptions: {}, transition: { default: "fade" }, showTimeout: { default: 0 }, hideTimeout: { default: 200 } }, emits: ["visible-change", "click-outside"], setup(o2, { expose: B2, emit: L2 }) {
  const N2 = o2, $2 = L2, E = l(false), O = l({}), R = l({}), Y = l({}), q = l(null), A = l(null), D = l(null), I = i(() => N2.virtualTriggering ? N2.virtualRef ?? A.value : A.value), M = i(() => ({ placement: N2.placement, modifiers: [{ name: "offset", options: { offset: [0, 9] } }], ...N2.popperOptions })), z = i(() => "hover" === N2.trigger ? N2.showTimeout : 0), C = i(() => "hover" === N2.trigger ? N2.hideTimeout : 0);
  let F, G, H;
  function J() {
  ...
  }(N2, I, O), (e2, t2) => (r(), u("div", s({ class: "ym-tooltip", ref_key: "containerNode", ref: q }, v(R.value, true)), [e2.virtualTriggering ? c(e2.$slots, "default", { key: 1 }, void 0, true) : (r(), u("div", s({ key: 0, class: "ym-tooltip__trigger", ref_key: "_triggerNode", ref: A }, v(O.value, true)), [c(e2.$slots, "default", {}, void 0, true)], 16)), p(m, { name: e2.transition, onAfterLeave: U }, { default: d(() => [E.value ? (r(), u("div", s({ key: 0, class: "ym-tooltip__popper", ref_key: "popperNode", ref: D }, v(Y.value, true)), [c(e2.$slots, "content", {}, () => [f(g(e2.content), 1)], true), t2[0] || (t2[0] = h("div", { id: "arrow", "data-popper-arrow": "" }, null, -1))], 16)) : _("", true)]), _: 3 }, 8, ["name"])], 16));
