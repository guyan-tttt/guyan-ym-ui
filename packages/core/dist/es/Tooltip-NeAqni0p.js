...
import { u as k } from "./hooks-DZI5xxe9.js";
import { C as T, f as b, z as w, g as x, i as j } from "./vendor-IunAiIJb.js";
import { _ as B, w as L } from "./utils-JcduRB7A.js";
const N = B(o({ name: "YmTooltip", __name: "Tooltip", props: { virtualRef: {}, virtualTriggering: { type: Boolean }, content: {}, trigger: { default: "hover" }, placement: { default: "bottom" }, manual: { type: Boolean }, disabled: { type: Boolean }, popperOptions: {}, transition: { default: "fade" }, showTimeout: { default: 0 }, hideTimeout: { default: 200 } }, emits: ["visible-change", "click-outside"], setup(o2, { expose: B2, emit: L2 }) {
  const N2 = o2, $2 = L2, E = l(false), O = l({}), R = l({}), Y = l({}), z = l(null), A = l(null), C = l(null), D = i(() => N2.virtualTriggering ? N2.virtualRef ?? A.value : A.value), I = i(() => ({ placement: N2.placement, modifiers: [{ name: "offset", options: { offset: [0, 9] } }], ...N2.popperOptions })), M = i(() => "hover" === N2.trigger ? N2.showTimeout : 0), q = i(() => "hover" === N2.trigger ? N2.hideTimeout : 0);
  let F, G, H;
  function J() {
  ...
  return n(() => {
    N2.manual || S(), F = w(x(Q, null, true), M.value), G = w(x(Q, null, false), q.value);
  }), B2({ show: J, hide: function() {
    F == null ? void 0 : F.cancel(), Q(false);
  } }), t(E, (e2) => {
    e2 && A.value && C.value && (H = y(A.value, C.value, I.value));
  ...
  }(N2, D, O), (e2, t2) => (r(), u("div", s({ class: "ym-tooltip", ref_key: "containerNode", ref: z }, v(R.value, true)), [e2.virtualTriggering ? c(e2.$slots, "default", { key: 1 }, void 0, true) : (r(), u("div", s({ key: 0, class: "ym-tooltip__trigger", ref_key: "_triggerNode", ref: A }, v(O.value, true)), [c(e2.$slots, "default", {}, void 0, true)], 16)), p(m, { name: e2.transition, onAfterLeave: U }, { default: d(() => [E.value ? (r(), u("div", s({ key: 0, class: "ym-tooltip__popper", ref_key: "popperNode", ref: C }, v(Y.value, true)), [c(e2.$slots, "content", {}, () => [f(g(e2.content), 1)], true), t2[0] || (t2[0] = h("div", { id: "arrow", "data-popper-arrow": "" }, null, -1))], 16)) : _("", true)]), _: 3 }, 8, ["name"])], 16));
