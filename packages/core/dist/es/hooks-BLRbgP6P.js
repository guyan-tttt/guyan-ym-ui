import { isRef as e, watch as t, onMounted as n, onBeforeUnmount as r, unref as a, computed as o, getCurrentInstance as l, useSlots as s, watchEffect as i, inject as c, ref as u } from "vue";
import { f as d, z as p, j as m, A as f, a as v, n as h, o as g } from "./vendor-BmDHKAAA.js";
function x(o2, l2, s2) {
  e(o2) ? t(o2, (e2, t2) => {
...
function b(e2 = "ym") {
  return o(() => `${e2}-${T.prefix}-${T.current++}`);
}
...
function k() {
  ...
  i(() => {
    (null == r2 ? void 0 : r2.props.disabled) ? y(a2 ?? [], (e3) => {
...
function M(e2) {
  return v(c(h, g({ locale: F.name, messages: { en: F.el } })), "install");
}
function B(e2) {
...
const D = u(0);
function j(e2 = 2e3) {
  const t2 = u(e2), n2 = o(() => t2.value + D.value);
...
function E(e2, { afterBlur: t2, afterFocus: n2, beforeBlur: r2 } = {}) {
  const a2 = l(), { emit: o2 } = a2, s2 = u(), i2 = u(false);
  return x(s2, "click", () => {
    var t3;
    null == (t3 = e2.value) || t3.focus();
  }), { wrapperRef: s2, isFocused: i2, handlerFocus: (e3) => {
    i2.value || (i2.value = true, o2("focus", e3), null == n2 || n2());
  }, handlerBlur: (e3) => {
    var n3;
    p(r2) && r2(e3) || e3.relatedTarget && (null == (n3 = s2.value) ? void 0 : n3.contains(e3.relatedTarget)) || i2.value && (i2.value = false, o2("blur", e3), null == t2 || t2());
  } };
}
function L(e2) {
  const t2 = l();
