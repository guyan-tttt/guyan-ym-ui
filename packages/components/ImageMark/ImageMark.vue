...
import { ref , onMounted , nextTick, watch, defineOptions, computed } from 'vue'
import {  Canvas, Rect, FabricImage, Line, Circle, FabricObject} from 'fabric';
import { v4 as uuidv4 } from 'uuid';
import type { EditorType, ImageEditorProps, ImageEditorEmits, ImageEditorInstance, ShapeObj} from './type'
