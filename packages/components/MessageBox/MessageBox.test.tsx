...
describe("MessageBox Component", () => {
  it("renders correctly", async () => {
    ...
    MessageBox(props);
    await rAF();
    const header = document.querySelector(".ym-message-box__header");
    const title = document.querySelector(".ym-message-box__title");
    const message = document.querySelector(".ym-message-box__message");
  ...
  it("triggers confirm action on confirm button click", async () => {
    ...
    const doAction = vi.fn();
    MessageBox(props)
      .then((action:any) => doAction(action))
    await rAF();

    const confirmBtn = document.querySelector(
      ".ym-message-box__footer-btn"
    ) as HTMLButtonElement;
    confirmBtn.click();
    await rAF();
